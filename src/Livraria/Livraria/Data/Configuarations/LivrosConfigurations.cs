...
namespace Livraria.Data.Configuarations
{
    public class LivrosConfigurations : IEntityTypeConfiguration<Livros>
    {
        public void Configure(EntityTypeBuilder<Livros> b)
        {
            ...
            b.Property(b => b.QuantidadeEmprestimo)
                .HasColumnName(nameof(Livros.QuantidadeEmprestimo))
                .IsRequired();

            b.Property(b => b.PrmitirEmprestimo)
                .HasColumnName(nameof(Livros.PrmitirEmprestimo))
                .HasColumnType("bit")
